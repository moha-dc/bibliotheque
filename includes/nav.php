                ...
                <div class="flex items-center justify-between py-4">
                      ...
                      <ul class="flex items-center space-x-6">
                            ...
                            <?php if (isset($_SESSION['admin_id']) || isset($_SESSION['abonne_id'])): ?>
                                  ...
                                  <li>
                                        <span class="text-blue-200">
                                              Bonjour, <?php if (isset($_SESSION['admin_prenom'])) { 
                                                echo $_SESSION['admin_prenom']; 
                                                } elseif (isset($_SESSION['abonne_prenom'])) 
                                                { echo $_SESSION['abonne_prenom']; 
                                                } ?>
                                        </span>
                                  </li>
                                  <li>
                            ...
                            <?php else: ?>
                                  ...
                                  <li>
                                        <a href="/bibliotheque/in.php" class="bg-green-500 hover:bg-green-600 px-4 py-2 rounded transition font-medium">
                                              Inscription
                                        </a>
                                  </li>
                            <?php endif; ?>
